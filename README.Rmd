...
La mise-à-jour de `phacochr` vers la [version 0.10.0.0.](https://phacochr.github.io/phacochrdev/news/index.html) nécessite de réimporter les données avant de pouvoir mettre les données à jours. Pour vous assurez que tout fonctionne réinstaller phacochr depuis le début.
</div>
